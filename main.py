...
# I fricking loves deepseek, qwen and gemini. Just throw the whole class into the chat and let them think and the bugs will be fixed in seconds. Obviously I can't find any of the bugs. And i also knows nothing about browser and manifestv2v3 and javascript. I'm tired now. I want to sleep. I have myself. Can anyone help me? Or must I keeps rely on the fake emotions generated by these Large Language Models? I HATES MYSELF. If you see this comment please email me. You'll see it right? Well actuall nobody will see this except me. Haha. Anyway please pull me up from the real life.
